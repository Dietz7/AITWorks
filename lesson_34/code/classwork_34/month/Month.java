...
public enum Month {
    ...
    NOV(11,"November", 30), DEC(12,"December", 31);; // ; appeared
    // fields
    private int number;
    private String name;
    private int days;
    ...
    public Month plusMonth(int quantity){
        ...
        Month [] month = values();
        int res = index % month.length;  //instead of 12 , ostatochnoje delenije
        return month[res]; // return object Month with index res
    }
