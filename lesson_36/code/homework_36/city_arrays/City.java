...
public class City implements Comparable <City>{
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(name, city.name) && Objects.equals(country, city.country);//Compare the name
        // and country fields:
    }
    ...
    public int compareTo(City o) {
       return this.name.compareTo(o.name);// native sorting by name of the city
    }
}
