...
public class Cities {
    ...
    public static void main(String[] args) {
        ...
        List<String> cityList = Arrays.asList("Augsburg", "Munich", "Berlin", "Heidelberg", "Worms", "Frankfurt am Main",
                "Bremen", "Bonn", "Braunschweig");
        char firstLetter = 'B';
    ...
    private static List<String> filterCity(List<String> cityList, char firstLetter) {
        return cityList.stream()
                .filter(city->city.startsWith(String.valueOf(firstLetter)))
