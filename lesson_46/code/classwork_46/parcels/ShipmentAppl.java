...
public class ShipmentAppl {
    ...
    public static void main(String[] args) {
        ...
        //numbers for Containers
        List<Integer> numberOfContainers = IntStream.range(1, numContainers + 1)
                .boxed()
                .toList();
        //print of numbers of the containers
        System.out.println("--------------------------number of containers-----------------------------------------");
        numberOfContainers.forEach(System.out::println);
        System.out.println("----------------------------------------------------------------------------------------");

        // print containers
        //IntStream.range(0, numContainers).forEach(index -> {
            //Container container = containers.get(index);
            //System.out.println("Container " + numberOfContainers.get(index) + " : " + container.getLabel());
        ...
        //find container with max quantity of parcels
